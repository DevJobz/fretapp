            ...
            case 'informacoes':
                conteudo = `
                    ...
                    <form id="formInformacoes">
                        ...
                        <input type="text" id="nome" name="nome" value="Maria Souza" required>

                        <label for="email">E-mail:</label>
                        <input type="email" id="email" name="email" value="maria.souza@example.com" required>

                        <label for="telefone">Telefone:</label>
                        <input type="tel" id="telefone" name="telefone" value="(11) 98888-8888" required>
